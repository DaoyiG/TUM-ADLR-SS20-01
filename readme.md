...
This is a fresh new paper from ICLR 2020. The author proposed a regularization technique for MAML. It would be a big success ***if we can convert this in MAML-RL algorithm***.
